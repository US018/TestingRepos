    ...
    public class FirstController : Controller
    {
        ...
        public ActionResult Edit(DataModel modle)
        {
            ...
            if (data != null)
            {
                ...
                data.FatherName = modle.FatherName;
                data.occupation = modle.occupation;
                data.date = modle.date;
                data.gender = modle.gender;
                data.collage = modle.collage;
                data.board = modle.board;
                data.Parcentage = modle.Parcentage;
